<form action='?'>
  <div class="input-group my-3">
    <input type="text" class="form-control" name="search" value="{$search_text}" placeholder="{$search_placeholder}"
      aria-label="{$search_text}" aria-describedby="button-addon2">
...
<div class="list-group mb-2">
  ...
  <div class="list-group-item"><a href="{$url}/usr_set"><img src="{$MAI_TPL}style/images/gdir.gif"
        alt="." />&nbsp;{$settings}</a></div>
  <div class="list-group-item"><a href="{$url}/request"><img src="{$MAI_TPL}style/images/gdir.gif"
        alt="." />&nbsp;{$request}</a></div>
  <div class="list-group-item"><a href="{$url}/tos"><img src="{$MAI_TPL}style/images/gdir.gif"
        alt="." />&nbsp;{$terms_of_service}</a></div>
  <div class="list-group-item"><a href="{$url}/disclaimer"><img src="{$MAI_TPL}style/images/gdir.gif"
