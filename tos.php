...
$set->name reserves the right to change any and all content, software and other items used or contained at $set->name and any services and applications offered through the $set->name site at any time without notice.") . "</div></div>";
