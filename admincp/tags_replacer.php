...
$links[] = "<li class='breadcrumb-item active' aria-current='page'>Tags Replacer</li>";
...
if ($_GET['act']) {
    ...
    if ($_GET['act'] == 'change') {
        echo 'Song Title: <input size="12" type="text" class="input" name="mp3_title" value="' . htmlentities($_POST['mp3_title']) . '">
            ...
            <textarea name="mp3_comment" rows="5">' . (isset($_POST['mp3_comment']) ? htmlentities($_POST['mp3_comment']) : htmlentities($set->plugins['comment_tag'])) . '</textarea>
        </div>';
